...
export const headers = [
    {id: PlayerOrderEnum.USERNAME, label: 'Username', sortable: true, align: 'left'},
    {id: PlayerOrderEnum.JOIN_DATE, label: 'Join Date', sortable: true, align: 'left'},
    {id: PlayerOrderEnum.RANK, label: 'Rank', sortable: true, align: 'left'},
    {id: PLAYER_ORDER_ENUM.DAYS_IN_CC, label: 'Number of Days in CC', sortable: true, align: 'left'},
    {id: PlayerOrderEnum.CREATED_AT, label: 'Creation Date', sortable: true, align: 'center'},
    {id: PlayerOrderEnum.UPDATED_AT, label: 'Last Updated', sortable: true, align: 'center'},
    {id: PLAYER_ORDER_ENUM.PREVIOUS_NAMES, label: 'Previous Names', sortable: false, align: 'center'},
    {id: PLAYER_ORDER_ENUM.COMMENT, label: 'Comment', sortable: false, align: 'left'},
    {id: PLAYER_ORDER_ENUM.ACTIONS, label: 'Actions', sortable: false, align: 'center'},
];
            ...
            <TableRow>
                {
                    headers.map((header, index) => (
                        header.sortable ?
                            <TableCell key={header.id} width={headerDistribution[index].percentage}
                                ...
                                <TableSortLabel active={orderBy === header.id}
                                                direction={(orderBy === header.id ? order.toLowerCase() : OrderEnum.ASC.toLowerCase()) as TableSortLabelTypeMap['props']['direction']}
                                                onClick={(e) => {
