...
export type IPlayerOrderEnum = "USERNAME" | "ID" | "JOIN_DATE" | "CREATED_AT" | "UPDATED_AT"
...
export const LOGIN_MUTATION: IRequest = {
    ...
    query: gql`mutation Login($username: String!, $password: String!) {
...
export const CREATE_PLAYER_MUTATION: IRequest = {
    type: MUTATION_OPERATION,
    query: gql`mutation CreatePlayer(
  $username: String!
...
export const DELETE_PLAYER_MUTATION: IRequest = {
    type: MUTATION_OPERATION,
    query: gql`mutation DeletePlayer($id: ID!) {
...
export const UPDATE_PLAYER_MUTATION: IRequest = {
    type: MUTATION_OPERATION,
    query: gql`mutation UpdatePlayer(
  $username: String!
  $joinDate: ISO8601DateTime!
  $rank: Int!
  $comment: String
...
export const SET_PASSWORD_MUTATION: IRequest = {
    type: MUTATION_OPERATION,
    query: gql`mutation SetPassword($id: ID!, $password: String!) {
...
export const CREATE_COMPETITION_MUTATION: IRequest = {
    type: MUTATION_OPERATION,
    query: gql`mutation CreateCompetition($externalUrl: String) {
...
export const UPDATE_COMPETITION_MUTATION: IRequest = {
    type: MUTATION_OPERATION,
    query: gql`mutation UpdateCompetition($externalUrl: String, $id: ID!) {
          updateCompetition(
...
export const DELETE_COMPETITION_MUTATION: IRequest = {
    type: MUTATION_OPERATION,
    query: gql`mutation DeleteCompetition($id: ID!) {
...
export const CREATE_COMPETITION_RECORD_MUTATION: IRequest = {
    type: MUTATION_OPERATION,
    query: gql`mutation CreateCompetitionRecord(
  $xp: BigInt!
  $position: BigInt!
  $playerId: ID!
  $competitionId: ID!
...
export const UPDATE_COMPETITION_RECORD_MUTATION: IRequest = {
    type: MUTATION_OPERATION,
    query: gql`mutation UpdateCompetitionRecord(
  $xp: BigInt!
  $position: BigInt!
  $playerId: ID!
  $competitionId: ID!
...
export const DELETE_COMPETITION_RECORD_MUTATION: IRequest = {
    type: MUTATION_OPERATION,
    query: gql`mutation DeleteCompetitionRecord($id: ID!) {
...
export const CREATE_PAYOUT_MUTATION: IRequest = {
    type: MUTATION_OPERATION,
    query: gql`mutation CreatePayout($amount: Int!, $paidById: ID!, $competitionRecordId: ID!) {
  createPayout(
    input: {
      attributes: {
        amount: $amount
...
export const UPDATE_PAYOUT_MUTATION: IRequest = {
    type: MUTATION_OPERATION,
    query: gql`mutation UpdatePayout(
  $amount: Int!
  $paidById: ID!
...
export const DELETE_PAYOUT_MUTATION: IRequest = {
    type: MUTATION_OPERATION,
    query: gql`mutation DeletePayout($id: ID!) {
...
export const COMPETITION_RECORDS_QUERY: IRequest = {
    type: QUERY_OPERATION,
    query: gql`query CompetitionRecords(
          $startPosition: Int
          $endPosition: Int
          $startXp: Int
          $endXp: Int
...
export const COMPETITION_QUERY: IRequest = {
    type: QUERY_OPERATION,
    query: gql`query Competition($id: ID!) {
          competition(id: $id) {
            competitionRecords {
              id
              xp
